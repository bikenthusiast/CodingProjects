...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/parallels/temporary/CodingProjects2/catkin_ws/src/third_party/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/parallels/temporary/CodingProjects2/catkin_ws/devel/.private/image_geometry)
  ...
  set(image_geometry_INSTALL_PREFIX /home/parallels/temporary/CodingProjects2/catkin_ws/install)
...
if(NOT "/home/parallels/temporary/CodingProjects2/catkin_ws/src/third_party/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/parallels/temporary/CodingProjects2/catkin_ws/src/third_party/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parallels/temporary/CodingProjects2/catkin_ws/src/third_party/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/parallels/temporary/CodingProjects2/catkin_ws/devel/.private/image_geometry/lib;/home/parallels/temporary/CodingProjects2/catkin_ws/devel/lib;/home/parallels/projects/catkin_ws/devel/lib;/opt/ros/melodic/lib)
