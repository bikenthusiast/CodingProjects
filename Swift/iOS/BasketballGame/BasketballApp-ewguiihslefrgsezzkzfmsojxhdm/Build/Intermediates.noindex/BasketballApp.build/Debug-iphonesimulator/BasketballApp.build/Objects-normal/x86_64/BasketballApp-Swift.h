...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BasketballApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13BasketballApp11AppDelegate")
...
SWIFT_CLASS("_TtC13BasketballApp13SceneDelegate")
...
SWIFT_CLASS("_TtC13BasketballApp8leagueVC")
@interface leagueVC : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified nxtButton;
- (void)viewDidLoad;
- (IBAction)unwindFromSkillVC1WithUnwindSegue1:(UIStoryboardSegue * _Nonnull)unwindSegue1;
...
SWIFT_CLASS("_TtC13BasketballApp7skillVC")
...
SWIFT_CLASS("_TtC13BasketballApp9welcomeVC")
@interface welcomeVC : UIViewController
- (void)viewDidLoad;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified goButton;
- (IBAction)unwindFromSkillVCWithUnwindSegue:(UIStoryboardSegue * _Nonnull)unwindSegue;
- (IBAction)onGoButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
